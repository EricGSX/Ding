...
<head>
    <meta charset="UTF-8">
    <title>Ding</title>
    <link rel="stylesheet" href="/Public/Home/User/css/bootstrap.min.css">
    <style>
        * {
            margin: 0;
            padding:0;
        ...
        body{
            background-image: url("/Public/Home/User/img/qqbg.png");
        ...
        div.QQlogin aside{
            width:100%;
            height:180px;
            background-image: url("/Public/Home/User/img/qq.gif");
            cursor: move;
        }
        div.down{
            width:100%;
       ...
       div.down div.touxiang > a{
           ...
           background: url("/Public/Home/User/img/touxiang.png") no-repeat;
           background-size: 100% 100%;
           opacity: .8;
           margin-top: 20px;
           margin-left: 30px;
        ...
        div.down div.touxiang dl span{
            ...
            width: 14px;
            height: 14px;
            background-image: url("/Public/Home/User/img/ptlogin.png");
            background-repeat: no-repeat;
            margin-right: 5px;
            opacity: .8;
        }
        ...
        div.down div.touxiang i.people{
            background: url("/Public/Home/User/img/input_username.png") no-repeat;
            position: absolute;
            width:35px;
            height:35px;
            top:75%;
        ...
        div.login-box span.first{
            ...
            width:20px;
            height:20px;
            background: url("/Public/Home/User/img/row.png") no-repeat;
            margin-left: 172px;
            top:8px;
        }
        div.login-box span.second{
            ...
            width:20px;
            height:20px;
            background: url("/Public/Home/User/img/press.png") no-repeat;
            margin-left: 168px;
            top:34px;
        }
        ...
        div.QQlogin i.close{
            ...
            top: 3px;
            right: 5px;
            background-image: url("/Public/Home/User/img/close.png");
        }
    </style>
</head>
<body>
    <div class="login">
        <a href="#"><img src="/Public/Home/User/img/qq.png" alt="">&nbsp;Ding/Guo</a>
    </div>
    ...
    <div class="QQlogin" id="QQlogin">
        ...
        <div class="row down">
            ...
            <form enctype="multipart/form-data" action="/index.php/Home/User/login" method="post">
            <div class="col-xs-6 login-box">
                <input type="text" name='nickname' placeholder="帐号（昵称）"><span class="first"></span>
                <input type="password" name='password' placeholder="密码"><span class="second" ></span>
                <label><input type="checkbox" class="three" checked='checked'>&nbsp;记住密码</label>
                <label class="auto-login"><input type="checkbox" class="four">&nbsp;自动登录</label>
                <input type = 'submit'  value = '登     录'/>
            </div>
            </form>
            <div class="col-xs-3 register">
                <a href="/index.php/Home/User/register">注册账号</a>
